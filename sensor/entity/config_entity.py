...
class DataTransformationConfig:
    ...
    def __init__(self,training_pipeline_config:TrainingPipelineConfig):
        ...
        self.transfrom_object_path = os.path.join(self.data_transformation_dir,"transformer","transform.pkl")
        ...
        self.lable_encoder_path =os.path.join(self.data_transformation_dir,"target_encoder",TARGET_ENCODER_OBJECT_FILE_NAME)
